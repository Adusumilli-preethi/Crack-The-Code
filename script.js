...
// Checking whether input fields are blank or not
if (a != '' && b != '' && c != '') {
    if (a == num1 && b == num2 && c == num3) {
        ...
        // Reload the page after a short delay (to allow the modal to display)
        setTimeout(function() {
            window.location.reload();
        }, 2000); // The page will refresh after 2 seconds
